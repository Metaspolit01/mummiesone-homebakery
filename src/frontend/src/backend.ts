...
import type { Category as _Category, Item as _Item, LoginResult as _LoginResult, Order as _Order } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addCategory(arg0: CategoryInput): Promise<Category> {
    ...
    async addItem(arg0: ItemInput): Promise<Item> {
        if (this.processError) {
            try {
    ...
    async createCustomRequest(arg0: OrderInput): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async deleteItem(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async toggleItemAvailability(arg0: string): Promise<Item | null> {
        if (this.processError) {
            try {
    ...
    async updateCategory(arg0: string, arg1: CategoryInput): Promise<Category | null> {
        if (this.processError) {
            try {
    ...
    async updateItem(arg0: string, arg1: ItemInput): Promise<Item | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Item]): Item | null {
