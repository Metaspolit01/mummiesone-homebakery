import { d as useAdminAuth, j as jsxRuntimeExports, N as Navigate, r as reactExports, R as React, f as reactDomExports, g as ReactDOM, c as cn, h as React2, u as useNavigate, P as PageLoader, e as ue } from "./index-BrrYKXKQ.js";
import { X, L as Layout, S as ShoppingBag } from "./Layout-DweZArJf.js";
import { c as createLucideIcon, i as composeRefs, j as useComposedRefs, k as useAllItems, a as useCategories, l as useOrders, m as useDeleteItem, n as useToggleItemAvailability, o as useAddItem, p as useUpdateItem, q as useAddCategory, B as Button, r as useUpdateOrderStatus, s as useUpdateCategory, t as useDeleteCategory } from "./useBakery-TYl0_4a8.js";
...
function formatDate(ts) {
  if (!ts) return "—";
  const ms = Number(ts);
  return new Date(ms > 1e12 ? ms : ms * 1e3).toLocaleDateString("en-IN", {
    day: "2-digit",
    month: "short",
    year: "numeric"
  });
...
function OrderDetailModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Order Details" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 text-sm font-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Order ID", value: `${order.id.slice(0, 8)}…` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Detail,
              {
                label: "Status",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Customer", value: order.userName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Phone", value: order.phone }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Detail,
              {
                label: "Delivery",
                value: order.deliveryType === "door" ? "Door Delivery" : "Self Pickup"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Payment", value: order.paymentMethod.toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Order Date", value: formatDate(order.orderDate) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Detail,
              {
                label: "Delivery Date",
          ...
          order.address && /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Address", value: order.address, full: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, { label: "Item", value: order.itemName, full: true }),
          order.isCustomRequest && order.customDescription && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Detail,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-3 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm mb-1.5 block", children: "Update Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: status, onValueChange: setStatus, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: STATUS_OPTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, className: "font-body", children: s }, s)) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: updateStatus.isPending ? "Saving…" : "Save Status"
            }
          )
        ] })
      ]
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm", children: "Item Name *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      value: form.name,
                  ...
                  categories.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          SelectItem,
                          {
                            value: c.name,
                            className: "font-body",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm", children: "Subcategory" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm", children: "Price (₹) *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      type: "number",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm", children: "Image URL" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      value: form.imageUrl,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isPending ? "Saving…" : "Save Item"
                  }
                )
              ] })
            ]
...
function ConfirmDeleteDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-sm", "data-ocid": "items.delete_dialog", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "This action cannot be undone. The item will be permanently removed." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
...
function CategoryRow({
  ...
  const [subInput, setSubInput] = reactExports.useState("");
  const [subs, setSubs] = reactExports.useState(category.subcategories);
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
            editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                "data-ocid": `categories.name_input.${index2 + 1}`
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-base", children: category.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-shrink-0", children: editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  ...
                  "data-ocid": `categories.cancel_edit_button.${index2 + 1}`,
                  children: "Cancel"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  "data-ocid": `categories.save_button.${index2 + 1}`,
                  children: "Save"
                }
              )
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  "data-ocid": `categories.edit_button.${index2 + 1}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  "data-ocid": `categories.delete_button.${index2 + 1}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
            subs.map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
            ...
            subs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body italic", children: "No subcategories" })
          ] }),
          editing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                "data-ocid": `categories.sub_input.${index2 + 1}`
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                "data-ocid": `categories.add_sub_button.${index2 + 1}`,
...
function AdminDashboardContent() {
  ...
  const [itemFormMode, setItemFormMode] = reactExports.useState(null);
  const [deleteItemTarget, setDeleteItemTarget] = reactExports.useState(null);
  const [newCatName, setNewCatName] = reactExports.useState("");
  const [newCatSubs, setNewCatSubs] = reactExports.useState("");
  ...
  const filteredOrders = orders.filter((o) => {
    const matchSearch = !orderSearch || o.userName.toLowerCase().includes(orderSearch.toLowerCase()) || o.id.toLowerCase().includes(orderSearch.toLowerCase());
  ...
  async function handleToggle(id) {
    try {
      ...
      ue.error("Failed to toggle availability");
    }
  }
  async function handleAddCategory(e) {
    e.preventDefault();
    if (!newCatName.trim()) return;
    const subcategories = newCatSubs.split(",").map((s) => s.trim()).filter(Boolean);
    try {
      ...
      ue.error("Failed to add category");
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { hideNav: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "gradient-primary shadow-warm sticky top-0 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-primary-foreground text-xl font-bold", children: "Mummies One" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/60 text-sm font-body ml-2", children: "Admin" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { className: "w-5 h-5 text-primary-foreground" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-foreground text-2xl font-bold leading-none", children: stat.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs font-body mt-0.5 truncate", children: stat.label })
            ] })
          ]
        },
        stat.label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "orders", className: "w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "mb-6 font-body", "data-ocid": "admin.tabs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "orders", "data-ocid": "admin.orders_tab", children: [
            "Orders",
            pendingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1.5 inline-flex items-center justify-center w-5 h-5 rounded-full bg-yellow-400 text-yellow-900 text-xs font-bold leading-none", children: pendingCount })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "items", "data-ocid": "admin.items_tab", children: "Items" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "categories", "data-ocid": "admin.categories_tab", children: "Categories" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "orders", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 min-w-48 max-w-xs", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: ["All", ...STATUS_OPTIONS].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setStatusFilter(s),
                    className: `px-3 py-1.5 rounded-lg text-sm font-body font-medium border transition-smooth ${statusFilter === s ? "gradient-primary text-primary-foreground border-transparent" : "bg-card text-muted-foreground border-border hover:border-primary/40 hover:text-foreground"}`,
          ...
          ordersLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}) : filteredOrders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "No orders found" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: orderSearch || statusFilter !== "All" ? "Try adjusting your filters" : "Orders will appear here once customers place them." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-xl border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm font-body min-w-[640px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/40 border-b border-border", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Item" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Delivery Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Status" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filteredOrders.map((order, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground", children: order.userName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: order.phone }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground", children: order.itemName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: formatDate(order.deliveryDate) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "items", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-foreground text-lg font-semibold", children: "Menu Items" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
          ...
          itemsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}) : items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "text-center py-16 text-muted-foreground font-body",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "No items yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-4", children: "Add your first menu item." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "sm",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-xl border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm font-body min-w-[700px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/40 border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Item" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Category" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left font-semibold text-muted-foreground", children: "Subcategory" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-right font-semibold text-muted-foreground", children: "Price" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center font-semibold text-muted-foreground", children: "Available" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center font-semibold text-muted-foreground", children: "Actions" })
            ] }) }),
              ...
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-muted flex items-center justify-center flex-shrink-0 text-lg", children: "🎂" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground", children: item.subcategory || "—" }),
          ...
          itemFormMode !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
            ItemFormModal,
            {
              title: itemFormMode === "add" ? "Add New Item" : "Edit Item",
              initial: itemFormMode === "add" ? EMPTY_ITEM : {
              ...
              categories,
              onSave: itemFormMode === "add" ? (d) => void handleAddItem(d) : (d) => void handleUpdateItem(d),
              onClose: () => setItemFormMode(null),
              isPending: itemFormMode === "add" ? addItem.isPending : updateItem.isPending
            }
          ),
          deleteItemTarget && /* @__PURE__ */ jsxRuntimeExports.jsx(
            ConfirmDeleteDialog,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "categories", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "Add New Category" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm", children: "Category Name *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      value: newCatName,
          ...
          categories.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Add categories to organize your menu." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", "data-ocid": "categories.list", children: categories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryRow, { category: cat, index: i }, cat.id)) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-muted/40 border-t border-border mt-12 py-4 text-center text-xs text-muted-foreground font-body", children: [
      "© ",
...
function AdminDashboardPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDashboardContent, {}) });
}
export {
