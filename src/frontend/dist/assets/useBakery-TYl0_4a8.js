...
import { k as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, n as RequestStatusResponseStatus, U as UnknownError, o as RequestStatusDoneNoReplyErrorCode, p as RejectError, q as CertifiedRejectErrorCode, s as UNREACHABLE_ERROR, I as InputError, t as InvalidReadStateRequestErrorCode, v as ReadRequestType, w as Principal, x as IDL, y as MissingCanisterIdErrorCode, H as HttpAgent, z as encode, Q as QueryResponseStatus, A as UncertifiedRejectErrorCode, B as isV3ResponseBody, D as isV2ResponseBody, F as UncertifiedRejectUpdateErrorCode, G as UnexpectedErrorCode, J as decode, S as Subscribable, K as pendingThenable, O as resolveEnabled, V as shallowEqualObjects, W as resolveStaleTime, X as noop, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, a4 as hashKey, a5 as getDefaultState, r as reactExports, a6 as shouldThrowError, a7 as useQueryClient, a8 as useInternetIdentity, a9 as createActorWithConfig, j as jsxRuntimeExports, R as React, aa as clsx, c as cn, ab as Record, ac as Vec, ad as Variant, ae as Service, af as Func, ag as Opt, ah as Text, ai as Float64, aj as Bool, ak as Int } from "./index-BrrYKXKQ.js";
...
Service({
  "addCategory": Func([CategoryInput], [Category], []),
  "addItem": Func([ItemInput], [Item], []),
  "adminLogin": Func([Text, Text], [LoginResult], []),
  "createCustomRequest": Func([OrderInput], [Order], []),
  "createOrder": Func([OrderInput], [Order], []),
  "deleteCategory": Func([Text], [Bool], []),
  "deleteItem": Func([Text], [Bool], []),
  "getAllItems": Func([], [Vec(Item)], ["query"]),
  "getAllOrders": Func([], [Vec(Order)], ["query"]),
  "getCategories": Func([], [Vec(Category)], ["query"]),
  "getItem": Func([Text], [Opt(Item)], ["query"]),
  "getItems": Func([], [Vec(Item)], ["query"]),
  "getItemsByCategory": Func([Text], [Vec(Item)], ["query"]),
  "toggleItemAvailability": Func([Text], [Opt(Item)], []),
  "updateCategory": Func(
    [Text, CategoryInput],
    [Opt(Category)],
    []
  ),
  "updateItem": Func([Text, ItemInput], [Opt(Item)], []),
  "updateOrderStatus": Func([Text, Text], [Opt(Order)], []),
  "validateAdminToken": Func([Text], [Bool], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const OrderInput2 = IDL2.Record({
    ...
    "customDescription": IDL2.Text,
    "deliveryDate": IDL2.Int,
    "deliveryType": IDL2.Text,
    "address": IDL2.Text,
    "itemName": IDL2.Text,
    "phone": IDL2.Text,
    "isCustomRequest": IDL2.Bool
  });
  ...
  return IDL2.Service({
    "addCategory": IDL2.Func([CategoryInput2], [Category2], []),
    "addItem": IDL2.Func([ItemInput2], [Item2], []),
    "adminLogin": IDL2.Func([IDL2.Text, IDL2.Text], [LoginResult2], []),
    "createCustomRequest": IDL2.Func([OrderInput2], [Order2], []),
    "createOrder": IDL2.Func([OrderInput2], [Order2], []),
    "deleteCategory": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "deleteItem": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "getAllItems": IDL2.Func([], [IDL2.Vec(Item2)], ["query"]),
    "getAllOrders": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    "getCategories": IDL2.Func([], [IDL2.Vec(Category2)], ["query"]),
    "getItem": IDL2.Func([IDL2.Text], [IDL2.Opt(Item2)], ["query"]),
    "getItems": IDL2.Func([], [IDL2.Vec(Item2)], ["query"]),
    "getItemsByCategory": IDL2.Func([IDL2.Text], [IDL2.Vec(Item2)], ["query"]),
    "toggleItemAvailability": IDL2.Func([IDL2.Text], [IDL2.Opt(Item2)], []),
    "updateCategory": IDL2.Func(
      [IDL2.Text, CategoryInput2],
      [IDL2.Opt(Category2)],
      []
    ),
    "updateItem": IDL2.Func([IDL2.Text, ItemInput2], [IDL2.Opt(Item2)], []),
    "updateOrderStatus": IDL2.Func([IDL2.Text, IDL2.Text], [IDL2.Opt(Order2)], []),
    "validateAdminToken": IDL2.Func([IDL2.Text], [IDL2.Bool], ["query"])
  });
};
class Backend {
  ...
  async createCustomRequest(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.createCustomRequest(arg0);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function useItemsByCategory(category) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useUpdateItem() {
  ...
  return useMutation({
    mutationFn: async ({ id, input }) => {
      if (!actor) throw new Error("Actor not ready");
      return actor.updateItem(id, input);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["items"] });
    }
...
function useCreateCustomRequest() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (input) => {
      if (!actor) throw new Error("Actor not ready");
      return actor.createCustomRequest(input);
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["orders"] });
    }
...
export {
  ...
  Slot as S,
  useCategories as a,
  useItemsByCategory as b,
  createLucideIcon as c,
  cva as d,
  useItem as e,
  useCreateCustomRequest as f,
  usePlaceOrder as g,
  useAdminLogin as h,
  composeRefs as i,
  ...
  useOrders as l,
  useDeleteItem as m,
  useToggleItemAvailability as n,
  useAddItem as o,
  useUpdateItem as p,
  useAddCategory as q,
  useUpdateOrderStatus as r,
